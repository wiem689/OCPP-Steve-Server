Feature: Automed Operations for Clear and Get Charging Profile Without Set 
As a user, I should make some operations 
Description: Clear and Get Charging Profile
 ...
 Scenario Outline: Operations when User on Clear and Get Charging Profile  
