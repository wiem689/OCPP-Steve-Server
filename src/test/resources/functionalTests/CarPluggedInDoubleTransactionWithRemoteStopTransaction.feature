Feature: Automed Operations Remote Transaction pluggedIn Double Transaction
As a user, I should make some operations 
Description: Automation test Remote Transaction PluggedIn  : Double Start Transaction AND Stop remote Transaction at the end  With parameter Lock 
to test both of connector-Status "Available" and "Unavailable" 
  ...
  Scenario Outline: Operations to Get remote transaction Transaction pluggedIn
